    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even from just a paragraph of text, <span class=”highlight-bold”>MiroFish</span> can automatically generate a parallel world of up to <span class=”highlight-orange”>millions of Agents</span> based on the reality seeds within it. Inject variables from a god's-eye view to find the <span class=”highlight-code”>”local optimum”</span> in complex group interactions within a dynamic environment.
            </p>
            <p class="slogan-text">
              Let the future rehearse among Agents, let decisions emerge victorious after countless trials<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby. Upload multiple unstructured data files to initialize a simulation sequence.
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity-relation extraction & persona generation & environment configuration with simulation parameters</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter your simulation or prediction requirement in natural language (e.g. If Wuhan University issues an announcement revoking the disciplinary action against Xiao, what public opinion trends would emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Navigate immediately to the Process page (using a special identifier for new projects)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Use Space Grotesk as the primary heading font and JetBrains Mono as the code/label font.
