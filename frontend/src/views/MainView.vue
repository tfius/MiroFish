...
// Step State
const currentStep = ref(1) // 1: Graph Construction, 2: Environment Setup, 3: Run Simulation, 4: Report Generation, 5: Deep Interaction
const stepNames = ['Graph Construction', 'Environment Setup', 'Run Simulation', 'Report Generation', 'Deep Interaction']
