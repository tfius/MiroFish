...
// Read maxRounds from query params at init time to ensure the child component gets the value immediately
...
const handleGoBack = async () => {
  ...
  try {
    // First attempt graceful shutdown of the simulation environment
...
const startGraphRefresh = () => {
  ...
  addLog('Graph live refresh started (30s interval)')
