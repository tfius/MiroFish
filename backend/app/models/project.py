...
Used to persist project state server-side, avoiding large data transfers between API calls on the frontend
"""
...
class ProjectManager:
    ...
    def _get_project_text_path(cls, project_id: str) -> str:
        """Get the path for storing the project's extracted text"""
