...
def build_graph():
    """
    Endpoint 2: Build a graph from a project_id
    ...
    try:
        ...
        if project.status == ProjectStatus.GRAPH_BUILDING and not force:
            return jsonify({
                "success": False,
                "error": "Graph is already being built. Please do not resubmit. To force a rebuild, add force: true",
        ...
        def build_task():
            ...
            try:
                ...
                # Wait for Zep to finish processing (poll the processed status of each episode)
                task_manager.update_task(
                    task_id,
