...
class SimulationManager:
    ...
    Core features:
    1. Read entities from the Zep graph and filter them
    ...
    def prepare_simulation(
        ...
        3. Use LLM to intelligently generate simulation configuration parameters (time, activity level, post frequency, etc.)
        ...
        try:
            ...
            # Reddit has already been saved in real-time during generation; save once more to ensure completeness
            if progress_callback:
                progress_callback(
            ...
            # ========== Stage 3: LLM-powered simulation configuration generation ==========
            if progress_callback:
                progress_callback(
                    "generating_config", 0,
